...
def compileStudentCpp(stu_cpp_file,stu_output_name,inputfoler_name):
    ...
    stu_file = "g++ -std=c++11 "+str(stu_cpp_file)+" -o Stu_Lab1"
...
if __name__ == '__main__':
    ...
    if((foldername)=="" or (headername)=="" or outputname==""):
        ...
        # Re-Create sample-output folder even though it already exists
        outputfoler_name = "mkdir "+str(outputname)
        os.system(outputfoler_name)

        # Create student results folder
        stu_cases_path = "mkdir stu_result"
        os.system(stu_cases_path)

        # Compile program
        os.system("g++ -std=c++11 MainTest.cpp -o Lab1")

        # Create path var for input data
    ...
    #correct results
        ...
        header_rename = "mv " +(headername)+ " myVectorTemp.h"
        os.system(header_rename)

    #students' main cpp file to compile
        stu_cases_path = "stu_result"
        compileStudentCpp("MainTestTemp.cpp",stu_cases_path,foldername)
