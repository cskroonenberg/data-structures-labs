...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        while(getline(f_input, line))
        {
            ...
            */
            myList<string> ml_3 = myList<string>(myList<string>(ml_1));
            for (myList<string>::iterator itr = ml_2.end(); itr != ml_2.begin(); --itr)
            {
                ml_3.push_back(*itr);
            }
            /**
            ...
            */
            for (myList<string>::iterator itr = ml_3.begin(); itr != ml_3.end(); ++itr)
            {
                cout<<*itr<<" ";
            }
            cout<<endl;
            for (myList<string>::iterator itr = ml_3.end(); itr != ml_3.begin();itr--)
            {
                cout<<*itr<<" ";
            }
            cout<<endl;
            ...
            */
            myList<string>::iterator it = ml_3.begin();
